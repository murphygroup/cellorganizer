function [result_covariance] = finalize_running_covariance(given_final_sum_squares, given_number_data)
  ...
  result_covariance = given_final_sum_squares ./ (given_number_data - 1);
