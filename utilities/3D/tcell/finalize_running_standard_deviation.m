function [result_standard_deviation] = finalize_running_standard_deviation(given_final_standard_deviation, given_number_data)
  ...
  result_standard_deviation = sqrt(given_final_standard_deviation ./ (given_number_data - 1));
