function [result_mean] = update_running_mean(given_preceding_mean, given_parameters, given_index)
  ...
  % whos
  result_mean = given_preceding_mean + (given_parameters - given_preceding_mean) ./ given_index;
