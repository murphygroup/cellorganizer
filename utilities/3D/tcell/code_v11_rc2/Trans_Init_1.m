...
for i = 1 : numel(depths)
    ...
    if intensity_i > best_intensity && pdist2(L_i, R_i) > 5
        best_L_i = L_i;
        best_R_i = R_i;
    ...
    if false && rem(i, 10) == 0
        ...
        hold on, plot(L_i(1), L_i(2), 'r*', R_i(1), R_i(2), 'r*');
