...
%         
        ...
        [approximate_arrangement{i}, approximate_arrangement_mass_matrix{i}, approximate_arrangement_embedding_info] = embed_partial_distance_matrix(dists, struct('method',  'nystrom-euclidean', 'force_positive_definiteness', false));
        hold_out(i) = i;
