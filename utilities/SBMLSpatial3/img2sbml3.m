...
for i = 1:length(names)
    ...
    elseif length(levels)>2
        for j = 2:length(levels)
            ...
            param.ind = nc;
            CSGboxes = getBox3(imgs{nc},['BB',names{i}],resolution,CSGboxes);
%             CSGboxes.list(nc) = getBox3(imgs{nc},names{i},[1,1,1],param);
...
sbmlStruct = createImg2SBMLstruct3(imgs,param);
