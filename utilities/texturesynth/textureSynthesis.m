...
%%%%%%%%%%%%%%%%%
% imwrite(mat2gray(im*255/max(im(:)),[0 255]),'/home/tingz/matlab/data/proposal/teximgs/start.bmp','bmp')
...
if cmask(1),
  ...
  %%%%%%%%%%tmp for saving intermediate results%%%%%%%%%%%
%   imwrite(mat2gray(im*255/max(im(:)),[0 255]),sprintf('/home/tingz/matlab/data/proposal/teximgs/iter%d.bmp',niter),'bmp')
