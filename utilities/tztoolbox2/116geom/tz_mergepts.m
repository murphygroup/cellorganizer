function pts = tz_mergepts(pts,mindist)
%TZ_MERGEPTS Obsolete. See ML_MERGEPTS.
%   PTS2 = TZ_MERGEPTS(PTS,MINDIST) returns a [point array] base on the
...
error('of','tz_mergepts','ml_mergepts');
