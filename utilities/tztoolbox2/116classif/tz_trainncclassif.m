function out = tz_trainncclassif(x,y,param)
%TZ_TRAINNCCLASSIF Train a nearest center classifier.
%   OUT = TZ_TRAINNCCLASSIF(X,Y) returns a nearest center classifier trained
...
%           with label i.
%   
%   OUT = TZ_TRAINNCCLASSIF(X,Y,PARAM) also allows setting paramters. PARAM is a
