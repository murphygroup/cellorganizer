function tz_report_writer(outputfile, pvalue, ts, both, featmat1, featmat2, setname1, setname2, slfnames, slfids, slfdescrp, conf, id, succ,localhost)

%TZ_REPORT_WRITER Obsolete

error(tz_genmsg('of','tz_report_writer','ml_report_writer'));
...
if succ<=0
    ...
    fprintf(fid,'<P><B>Multivariate testing method: </B>Two-sample Hotelling T2 test</P>');
    if pvalue<=conf
