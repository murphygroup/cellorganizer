...
%                 'Label','Nearest neighbour statistic');
	...
	b = uimenu('Parent',a, ...
		...
		c = uimenu('Parent',b, ...
			...
			'Label','About TSTOOL', ...
                        'Callback', 'tstoolabout(''TSTOOL V1.11'');', ...
                        'Tag','About1');
%			'Callback', 'msgbox( { ''                       TSTOOL'' ; ''     Drittes Physikalisches Institut'';  ''Georg-August-Universität Göttingen''; ''                  1997-2001''} ,''About tstool'', ''none'' )'
		c = uimenu('Parent',b, ...
