function makeMeshOnly(preSBML)
%This function makes the SBML-spatial standard 'MeshOnly.xml' file. 
%
...
simpleCubeSBML = createSBMLFrameworkstruct({simpleCube},param);



outdir = [pwd, filesep, 'MeshOnly.xml'];

instance2SBML_mod([],simpleCubeSBML,outdir,[],model.proteinModel.resolution)